...
python early in mas_utils:
    ...
    def logrotate(logpath, filename):
        ...
        _m1_0utils__numformat = "{:02d}"
        _m1_0utils__numdelim = "."
        ...
        if len(filelist) > 1:
            fname, dot, largest_num = filelist.pop().rpartition(_m1_0utils__numdelim)
        ...
        new_path = os.path.normcase("".join([
            ...
            filename,
            _m1_0utils__numdelim,
            _m1_0utils__numformat.format(largest_num)
        ]))
        trydel(new_path)
