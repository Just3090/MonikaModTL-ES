    ...
    if mas_isMoniNormal(higher=True):
        ...
        menu:
            ...
            "Yeah.":
                ...
                call bye_prompt_sleep_goodnight_kiss (chance=4) from _call_bye_prompt_sleep_goodnight_kiss
...
label bye_prompt_sleep:
    if mas_isMoniNormal(higher=True):
        call bye_prompt_sleep_goodnight_kiss (chance=3) from _call_bye_prompt_sleep_goodnight_kiss_1
    ...
    if mas_shouldKiss(chance, cooldown=datetime.timedelta(minutes=5)):
        ...
        menu:
            ...
            "Sure, [m_name].":
                ...
                pause 2.0
                call monika_kissing_motion_short (initial_exp="6hubsa") from _call_monika_kissing_motion_short_3
                ...
                if random.randint(1, 3) == 1:
                    ...
                    menu:
                        ...
                        "Okay.":
                            ...
                            show monika 6ekbsu zorder MAS_MONIKA_Z at t11 with dissolve_monika
                            pause 2.0
                            call monika_kissing_motion_short (initial_exp="6hubsa") from _call_monika_kissing_motion_short_4
    ...
    if mas_isMoniNormal(higher=True):
        ...
        menu:
            ...
            "Yeah.":
                ...
                call bye_prompt_sleep_goodnight_kiss (chance=4) from _call_bye_prompt_sleep_goodnight_kiss_2
