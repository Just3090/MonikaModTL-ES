...
init -3 python:
    ...
    class MASMonika(renpy.store.object):
        ...
        def remove_acs_in(self, accessory, acs_layer):
            ...
            acs_list = self._m1_sprite0x2dchart__get_acs(acs_layer)
            temp_space = {
                "acs_list": acs_list,
            }
    ...
    class MASArm(object):
        ...
        _m1_sprite0x2dchart__MPA_KEYS = (LAYER_BOT, LAYER_MID, LAYER_TOP)
    ...
    class MASHair(MASSpriteFallbackBase):
        ...
        _m1_sprite0x2dchart__MHM_KEYS = store.mas_sprites._genLK(("front", "back", "mid"))
    ...
    class MASClothes(MASSpriteFallbackBase):
        ...
        def __init__(self,
            ...
            self._m1_sprite0x2dchart__outfit_proc_acs = {}
            self._m1_sprite0x2dchart__outfit_proc_hair = None
        ...
        def _format_outfit_acs(self, outfit_acs_data):
            ...
            for acs_name_or_obj in outfit_acs_data:
                if isinstance(acs_name_or_obj, MASAccessoryBase):
                    ...
                    self._m1_sprite0x2dchart__outfit_proc_acs[acs_name_or_obj] = True
        ...
        def _format_outfit_hair(self, outfit_hair_data):
            ...
            if self.delay_outfit_validation:
                ...
                self._m1_sprite0x2dchart__outfit_proc_hair = outfit_hair_data
                return None
        ...
        def _proc_delayed_outfit_data(self):
            ...
            if self._m1_sprite0x2dchart__outfit_proc_hair is not None:
                self.outfit_hair = store.mas_sprites.get_sprite(
                    store.mas_sprites.SP_HAIR,
                    self._m1_sprite0x2dchart__outfit_proc_hair
                )
                self._m1_sprite0x2dchart__outfit_proc_hair = None
            
            
            data = {}
            for acs_name in self._m1_sprite0x2dchart__outfit_proc_acs:
                acs = store.mas_sprites.get_sprite(
                    store.mas_sprites.SP_ACS,
                    acs_name
                )
            ...
            self._m1_sprite0x2dchart__outfit_proc_acs = None
...
python early:
    ...
    class MASMoniIdleDisp(renpy.display.core.Displayable):
        ...
        def _m1_sprite0x2dchart__handle_group(self, group, add_to_list=True):
            """
            Handles a group OwO
        ...
        def _m1_sprite0x2dchart__select_exp(self):
            """
            ...
            while exp is None and self.exp_groups:
                ...
                if (
                    ...
                    exp = self._m1_sprite0x2dchart__handle_group(group, add_to_list=False)
            ...
            while isinstance(exp, MASMoniIdleExpGroup):
                ...
                chose_group = True
                exp = self._m1_sprite0x2dchart__handle_group(exp, add_to_list=True)
        ...
        def select_exp(self):
            ...
            if (
                ...
                exp = self._m1_sprite0x2dchart__select_exp()
        ...
        def visit(self):
            ...
            if self._predicted_exp is None:
                self._predicted_exp = self._m1_sprite0x2dchart__select_exp()
    ...
    class MASMoniWinkTransform(renpy.display.core.Displayable):
        ...
        def render(self, width, height, st, at):
            ...
            if st > self._last_st:
                ...
                self._m1_sprite0x2dchart__reset()
        ...
        def _m1_sprite0x2dchart__reset(self):
            """
        ...
        (
            ...
            MASMoniIdleExpRngGroup(
                [
                    ...
                    MASMoniIdleExp("1eua_follow", weight=30)
                ],
                max_uses=1,
            ...
            MASMoniIdleExpRngGroup(
                [
                    ...
                    MASMoniIdleExp("1eua_follow", weight=None)
                ],
                max_uses=1,
            ...
            MASMoniIdleExpRngGroup(
                [
                    ...
                    MASMoniIdleExp("5esu_follow", weight=None)
                ],
                max_uses=1,
                aff_range=(mas_aff.ENAMORED, mas_aff.ENAMORED),
                weight=11,
            ...
            MASMoniIdleExpRngGroup(
                [
                    ...
                    MASMoniIdleExp("1eua_follow", weight=70)
                ],
                max_uses=1,
            ...
            MASMoniIdleExpRngGroup(
                [
                    ...
                    MASMoniIdleExp("5esu_follow", weight=70)
                ],
                max_uses=1,
                aff_range=(mas_aff.LOVE, None),
                weight=26,
            ...
            MASMoniIdleExpRngGroup(
                [
                    ...
                    MASMoniIdleExp("5eubla_follow", weight=70)
                ],
                max_uses=1,
                aff_range=(mas_aff.LOVE, None),
                weight=5,
            ...
            MASMoniIdleExpRngGroup(
                [
                    ...
                    MASMoniIdleExp("5eubsa_follow", weight=70)
                ],
                max_uses=1,
                aff_range=(mas_aff.LOVE, None),
                weight=2,
