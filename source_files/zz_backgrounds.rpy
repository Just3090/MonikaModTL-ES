...
init -10 python:
    ...
    class MASBackgroundFilterManager(object):
        ...
        def progress(self):
            ...
            * progression changes via update:
            ...
            if (
                    pos_data[1] <= sfmn < pos_data[2]  
                    and sfmn < (pos_data[1] + pos_data[4]) 
            ):
    ...
    class MASFilterableBackground(object):
        ...
        def progress(self):
            ...
            return store.mas_sprites.FLT_DAY 
...
label monika_change_background_loop:
    ...
    call mas_background_change (sel_background, skip_leadin=skip_leadin, skip_transition=skip_transition, skip_outro=skip_outro, set_persistent=True) from _call_mas_background_change_1
...
label mas_background_change(new_bg, skip_leadin=False, skip_transition=False, skip_outro=False, set_persistent=False):
    ...
    call spaceroom (scene_change=not skip_transition, dissolve_all=True, bg_change_info=change_info, force_exp="monika 1hua") from _call_spaceroom_10
