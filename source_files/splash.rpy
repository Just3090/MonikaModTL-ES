...
# porteador: elimine verificacion para los rpa
...
label splashscreen:
    ...
    python:
        ensure_android_sprites_savedir()
        ensure_android_gifts_savedir()
    ...
    if store.mas_per_check.should_show_chibika_persistent():
        ...
        call mas_backups_you_have_bad_persistent from _call_mas_backups_you_have_bad_persistent
