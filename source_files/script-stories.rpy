...
label monika_short_stories_menu:
    ...
    python:
        ...
        switch_item = (_("I'd like to hear a ") + switch_str + _(" story"), "monika_short_stories_menu", False, False, 20)
    ...
    $ renpy.say(m, which + _(" story would you like to hear?") + end, interact=False)
...
label mas_scary_story_setup:
    ...
    if not persistent._mas_o31_in_o31_mode:
        ...
        call spaceroom (dissolve_all=is_scene_changing, dissolve_masks=are_masks_changing, force_exp='monika 1dsc_static') from _call_spaceroom_30
...
label mas_scary_story_cleanup:
    ...
    if not persistent._mas_o31_in_o31_mode:
        ...
        call spaceroom (dissolve_all=is_scene_changing, dissolve_masks=are_masks_changing, force_exp='monika 1dsc_static') from _call_spaceroom_31
        hide vignette

    call monika_zoom_transition (mas_temp_zoom_level, transition=1.0) from _call_monika_zoom_transition_3
...
label mas_story_tanabata:
    call mas_story_begin from _call_mas_story_begin_18
...
label mas_story_mindthegap:
    call mas_story_begin from _call_mas_story_begin_19
...
label mas_story_knock:
    call mas_story_begin from _call_mas_story_begin_20
