...
screen navigation():
    vbox:
        ...
        # botones de salir ahora tambien en android y quitando exclusividad de pc

        textbutton _("Exit") action Quit(confirm=(None if main_menu else _confirm_quit))
...
#begin language_picker
                ...
                vbox:
                    ...
                    textbutton "English" text_font "DejaVuSans.ttf" action [SetField(persistent, "language", "english"), Show("dialog", message="It is recommended to restart to apply the changes.\n\nOtherwise, some things may remain in Spanish.", ok_action=Hide("dialog"))]
                    textbutton "Español" text_font "DejaVuSans.ttf" action [SetField(persistent, "language", "spanish"), Show("dialog", message="Se recomienda reiniciar el juego\npara aplicar los cambios.\n\nDe lo contrario, es posible\nque algunas cosas se\nconserven en inglés.", ok_action=Hide("dialog"))]
                    # textbutton "Español (MX)" text_font "DejaVuSans.ttf" action [Language("spanish_mx"), SetField(persistent, "language", "spanish_mx"), Show("dialog", message="Se recomienda reiniciar el juego\npara aplicar los cambios.", ok_action=Hide("dialog"))]
                    # textbutton "Português (BR)" text_font "DejaVuSans.ttf" action [Language("ptBR"), SetField(persistent, "language", "ptBR"), Show("dialog", message="Recomenda-se reiniciar para aplicar as alterações.", ok_action=Hide("dialog"))]
...
screen give_custom_gift_screen():
    ...
    # Fondo animado y blur para modernidad
    add Solid("#000000c0") at gift_bg_fadein  # Fade-in

    frame at gift_frame_appear:
        style_prefix "gift_"
        xalign 0.5
        yalign 0.25
        xsize 960
        ysize 320
        background Frame("gui/frame.png", 960, 64)
        padding (0, 0, 0, 0)
        ...
        vbox:
            ...
            hbox:
                spacing 32
                xalign 0.5
                text "Enter the name of the gift for Monika\n(include the '.gift' or '.txt' extension):" xalign 0.5 size 24 color "#FFD9E8" outlines [(2, "#000", 0, 0)] at gift_text_appear
                textbutton "Give Gift":
                    at gift_button_appear
                    action [Function(give_custom_gift, gift_input), Return()]
                    style "gift_button_modern"
                textbutton "Close":
                    at gift_button_appear
                    action Return()
                    style "gift_button_modern"

            input value VariableInputValue("gift_input") length 999 xalign 0.5 xsize 420 color "#333" outlines [(1, "#FFD9E8", 0, 0)] at gift_input_appear

# Animación para el fondo
transform gift_bg_fadein:
    alpha 0.0
    linear 0.3 alpha 1.0

# Animaciones para la screen moderna
transform gift_frame_appear:
    alpha 0.0
    zoom 0.9
    linear 0.25 alpha 1.0 zoom 1.0

transform gift_text_appear:
    alpha 0.0
    yoffset 20
    linear 0.3 alpha 1.0 yoffset 0

transform gift_input_appear:
    alpha 0.0
    xoffset -30
    linear 0.3 alpha 1.0 xoffset 0

transform gift_button_appear:
    alpha 0.0
    yoffset 20
    linear 0.2 alpha 1.0 yoffset 0

# Estilo moderno para los botones
style gift_button_modern is button:
    xsize 180
    ysize 48
    font "gui/font/RifficFree-Bold.ttf"
    size 20
