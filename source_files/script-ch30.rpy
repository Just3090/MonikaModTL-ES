...
define MAS_PRONOUN_GENDER_MAP = {
    "his": {"M": _("his"), "F": _("her"), "X": _("their")},
    "he": {"M": _("he"), "F": _("she"), "X": _("they")},
    "hes": {"M": _("he's"), "F": _("she's"), "X": _("they're")},
    "heis": {"M": _("he is"), "F": _("she is"), "X": _("they are")},
    "bf": {"M": _("boyfriend"), "F": _("girlfriend"), "X": _("partner")},
    "man": {"M": _("man"), "F": _("woman"), "X": _("person")},
    "boy": {"M": _("boy"), "F": _("girl"), "X": _("person")},
    "guy": {"M": _("guy"), "F": _("girl"), "X": _("person")},
    "him": {"M": _("him"), "F": _("her"), "X": _("them")},
    "himself": {"M": _("himself"), "F": _("herself"), "X": _("themselves")},
    "hero": {"M": _("hero"), "F": _("heroine"), "X": _("hero")}
}
...
label ch30_main:
    ...
    call spaceroom (scene_change=True, dissolve_all=True, force_exp="monika 6dsc_static") from _call_spaceroom_33
...
label mas_ch30_post_holiday_check:
    ...
    if _mas_getAffection() <= -50 and seen_event("mas_affection_apology"):
        ...
        if persistent._mas_affection_should_apologise and not is_apology_present():
            $ mas_RaiseShield_core()
            call spaceroom (scene_change=True) from _call_spaceroom_34
            ...
            $ mas_RaiseShield_core()
            call spaceroom (scene_change=True) from _call_spaceroom_35
            ...
            $ mas_RaiseShield_core()
            call spaceroom (scene_change=True) from _call_spaceroom_36
    ...
    if gre_cb_label is not None:
        call expression gre_cb_label from _call_expression_5
...
label ch30_loop:
    ...
    call spaceroom (scene_change=scene_change, force_exp=force_exp, dissolve_all=should_dissolve_all, dissolve_masks=should_dissolve_masks) from _call_spaceroom_37
