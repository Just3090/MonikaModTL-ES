...
label mas_compliment_goodmood:
    if not renpy.seen_label("mas_compliment_goodmood_2"):
        call mas_compliment_goodmood_2 from _call_mas_compliment_goodmood_2
    else:
        call mas_compliment_goodmood_3 from _call_mas_compliment_goodmood_3
    return
        ...
        if (
            ...
            menu:
                ...
                "Sure, [m_name]!":
                    ...
                    call monika_holdme_prep (lullaby=MAS_HOLDME_NO_LULLABY, stop_music=True, disable_music_menu=True) from _call_monika_holdme_prep_8
                    call monika_holdme_start from _call_monika_holdme_start_8
                    call monika_holdme_end from _call_monika_holdme_end_4
