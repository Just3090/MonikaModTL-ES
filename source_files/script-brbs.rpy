...
label monika_idle_brb_callback:
    ...
    if mas_isMoniAff(higher=True):
        ...
        call mas_brb_generic_low_aff_callback from _call_mas_brb_generic_low_aff_callback
...
label monika_idle_writing_callback:
    ...
    if mas_isMoniNormal(higher=True):
        ...
        call mas_brb_generic_low_aff_callback from _call_mas_brb_generic_low_aff_callback_1
...
label monika_idle_shower_callback:
    if mas_isMoniNormal(higher=True):
        ...
        call mas_brb_generic_low_aff_callback from _call_mas_brb_generic_low_aff_callback_2
...
label monika_idle_coding_callback:
    if mas_isMoniNormal(higher=True):
        ...
        call mas_brb_generic_low_aff_callback from _call_mas_brb_generic_low_aff_callback_3
...
label monika_idle_workout_callback:
    if mas_isMoniNormal(higher=True):
        ...
        call mas_brb_generic_low_aff_callback from _call_mas_brb_generic_low_aff_callback_4
...
label monika_idle_nap_callback:
    if mas_isMoniNormal(higher=True):
        ...
        call mas_brb_generic_low_aff_callback from _call_mas_brb_generic_low_aff_callback_5
...
label monika_idle_screen_break_callback:
    if mas_isMoniNormal(higher=True):
        ...
        call mas_brb_generic_low_aff_callback from _call_mas_brb_generic_low_aff_callback_6
...
label monika_idle_reading_callback:
    if mas_isMoniNormal(higher=True):
        ...
        call mas_brb_generic_low_aff_callback from _call_mas_brb_generic_low_aff_callback_7
