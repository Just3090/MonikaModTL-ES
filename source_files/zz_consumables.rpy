...
label mas_consumables_generic_get(consumable):
    ...
    call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_25
...
label mas_consumables_generic_finish_having(consumable):
    ...
    call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_26
    $ consumable.acs.keep_on_desk = True
...
label mas_consumables_generic_finished_prepping(consumable):
    ...
    call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_27
    $ consumable.acs.keep_on_desk = True
...
label mas_consumables_candycane_finish_having:
    ...
    if not get_more:
        ...
        call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_29
        $ mas_consumable_candycane.acs.keep_on_desk = True
...
label monika_consumables_check:
    ...
    call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_30
