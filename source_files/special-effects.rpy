...
init -500 python in mas_parallax:
    ...
    class _ParallaxDecalContainer(renpy.display.core.Displayable):
        ...
        def __init__(self, base, *children):
            ...
            self._m1_special0x2deffects__sort_decals()
        ...
        def _m1_special0x2deffects__sort_decals(self):
            """
    ...
    class ParallaxSprite(renpy.display.core.Displayable):
        ...
        _m1_special0x2deffects__RED_DOT = store.Solid("#cd0202", xsize=1, ysize=1)
        _m1_special0x2deffects__GREEN_DOT = store.Solid("#66ff21", xsize=1, ysize=1)
        ...
        def _m1_special0x2deffects__get_transform_placement(self):
            """
        ...
        def update_offsets(self):
            ...
            transform_offset_x, transform_offset_y = self._m1_special0x2deffects__get_transform_placement()
        ...
        def _m1_special0x2deffects__debug_info_render(self, width, height, st, at, render):
            """
            ...
            red_point_surf = renpy.render(self._m1_special0x2deffects__RED_DOT, width, height, st, at)
            ...
            transform_x_offset, transform_y_offset = self._m1_special0x2deffects__get_transform_placement()
            ...
            green_point_surf = renpy.render(self._m1_special0x2deffects__GREEN_DOT, width, height, st, at)
        ...
        def render(self, width, height, st, at):
            ...
            if self._debug:
                self._m1_special0x2deffects__debug_info_render(width, height, st, at, render)
...
transform mas_kissing(_zoom, _y, time=2.0):
    i11
    xcenter 640 yanchor 0.89 yoffset 0
...
label monika_kissing_motion(transition=4.0, duration=2.0, hide_ui=True, initial_exp="6dubfd", mid_exp="6tkbfu", final_exp="6ekbfa", fade_duration=1.0
    ...
    $ _mas_kiss_y = 2060 - (1700 * (mas_sprites.value_zoom - 1.1)) + 0
...
label monika_kissing_motion_short(**kwargs):
    ...
    call monika_kissing_motion (**kwargs) from _call_monika_kissing_motion_10
    return
...
label monika_zoom_transition_reset(transition=3.0):
    call monika_zoom_transition (store.mas_sprites.default_zoom_level, transition) from _call_monika_zoom_transition_4
    return
