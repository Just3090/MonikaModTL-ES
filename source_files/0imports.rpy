...
# porteador: elimine verificacion del certificado
# y la linea para encodificar en utf-8
...
init -1505 python in mas_can_import:
    ...
    class MASImport_certifi(MASImport):
        ...
        def __init__(self):
            ...
            self._m1_0imports__cert_available = False
            self._m1_0imports__cert_update_promise = MASAsyncWrapper(self._update_cert)
            
            self._m1_0imports__cert_available_lock = threading.Lock()
            self._m1_0imports__cert_available_cond = threading.Condition(
                self._m1_0imports__cert_available_lock
            )
        ...
        def cert_available(self):
            ...
            """
            return self._m1_0imports__th_get_cert_avail()
        ...
        def import_try(self):
            ...
            self._m1_0imports__th_set_cert_avail(certifi.has_cert())
        ...
        def import_except(self, err):
            ...
            self._m1_0imports__th_set_cert_avail(False)
        ...
        def start_cert_update(self, force=False):
            ...
            """
            if not self._m1_0imports__cert_update_promise.ready:
                return self._m1_0imports__cert_update_promise
            
            
            self._m1_0imports__cert_update_promise._th_kwargs = {"force": force}
            
            
            self._m1_0imports__cert_update_promise.start()
            return self._m1_0imports__cert_update_promise
        ...
        def check_cert_update(self):
            ...
            """
            return self._m1_0imports__cert_update_promise.done()
        ...
        def get_cert_update(self):
            ...
            RETURNS: certifi RV value of the check_update function, or None if
                ...
                before calling this.
            """
            return self._m1_0imports__cert_update_promise.get()
        ...
        def reset_cert_update(self):
            ...
            not done yet.
            """
            self._m1_0imports__cert_update_promise.end()
        ...
        def _m1_0imports__th_get_cert_avail(self):
            """
            thread-safe get cert available - for internal use only

            RETURNS: cert_available value
            """
            self._m1_0imports__cert_available_cond.acquire()
            cert_avail = self._m1_0imports__cert_available
            self._m1_0imports__cert_available_cond.release()
            
            return cert_avail
        
        def _m1_0imports__th_set_cert_avail(self, value):
            """
            ...
            """
            self._m1_0imports__cert_available_cond.acquire()
            self._m1_0imports__cert_available = value
            self._m1_0imports__cert_available_cond.release()
...
init -1510 python in mas_can_import:
    ...
    class MASImport(object):
        ...
        def __init__(self, module_name, set_sys=False):
            ...
            IN:
                ...
                set_sys - pass True to allow this to overwrite the sys modules.
                    ...
                    (Default: False)
            """
            self._m1_0imports__module_name = module_name
            self._m1_0imports__set_sys = set_sys
            self._m1_0imports__enabled = False
            ...
            Data.imports[self._m1_0imports__module_name] = self
        ...
        def enabled(self):
            ...
            """
            return self._m1_0imports__enabled
        ...
        def module_name(self):
            ...
            """
            return self._m1_0imports__module_name
        ...
        def set_sys(self):
            ...
            """
            return self._m1_0imports__set_sys
        ...
        def load(self):
            ...
            """
            try:
                self._m1_0imports__enabled = self.import_try()
...
init -995 python in mas_can_import_data:
