...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("I'm okay with talking about..."),
            pool=True,
            unlocked=False,
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("I would like to see 'Unseen' again"),
            pool=True,
            unlocked=False,
            rules={"no_unlock":None}
        )
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_death",category=category,prompt=_("Death and dying"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['advice']
    addEvent(Event(persistent.event_database,eventlabel="monika_selfesteem",category=category,prompt=_("Self-esteem"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_japan",category=['ddlc'],prompt=_("DDLC's setting"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['avisos','escuela']
    else:
        category = ['advice','school']
    addEvent(Event(persistent.event_database,eventlabel="monika_high_school",category=category,prompt=_("High school"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_portraitof",category=category,prompt=_("Yuri's book"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_veggies",category=['monika'],prompt=_("Being a vegetarian"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_saved",category=['monika'],prompt=_("Saving Monika"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_color",category=['monika'],prompt=_("Favorite color"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['you']
    addEvent(Event(persistent.event_database,eventlabel="monika_listener",category=category,prompt=_("Good listener"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['trivia']
    addEvent(Event(persistent.event_database,eventlabel="monika_spicy",category=category,prompt=_("Spicy foods"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['you','ddlc']
    addEvent(Event(persistent.event_database,eventlabel="monika_why",category=category,prompt=_("Why play this game?"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['el Club de Literatura']
    else:
        category = ['literature club']
    addEvent(Event(persistent.event_database,eventlabel="monika_okayeveryone",category=category,prompt=_("Okay, everyone!"),random=True))
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Others still lingering"),
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_archetype",category=category,prompt=_("Character tropes"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_tea",category=category,prompt=_("Yuri's tea"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_favoritegame",category=['ddlc'],prompt=_("Favorite video game"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_anxious",category=category,prompt=_("Sudden anxiety"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['acerca de la vida']
    else:
        category = ['life']
    addEvent(Event(persistent.event_database,eventlabel="monika_friends",category=category,prompt=_("Making friends"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['acerca de la vida','escuela','sociedad']
    else:
        category = ['life','school','society']
    addEvent(Event(persistent.event_database,eventlabel="monika_college",category=category,prompt=_("Getting a higher education"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['monika','escuela']
    else:
        category = ['monika','school']
    addEvent(Event(persistent.event_database,eventlabel="monika_middleschool",category=category,prompt=_("Middle school life"),random=True))
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Wearing other clothes"),
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['media']
    addEvent(Event(persistent.event_database,eventlabel="monika_horror",category=category,prompt=_("Horror genre"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['literatura','multimedia','música']
    else:
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_wine",category=category,prompt=_("Yuri's wine"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_date",category=['romance'],prompt=_("Romantic date"),random=True))
...
label monika_kiss:
    if mas_isMoniEnamored(higher=True) and persistent._mas_first_kiss is not None:
        if (
            ...
            call monika_kissing_motion (duration=0.5, initial_exp="6hubsa", final_exp="6tkbfu", fade_duration=0.5) from _call_monika_kissing_motion_8
...
init python:
    if persistent.language == "spanish":
        category = ['miembros del club','multimedia']
    else:
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['life']
    addEvent(Event(persistent.event_database,eventlabel="monika_habits",category=category,prompt=_("Forming habits"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['life']
    addEvent(Event(persistent.event_database,eventlabel="monika_creative",category=category,prompt=_("Creative types"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_simulated",category=category,prompt=_("Simulated reality"),random=True))
...
label monika_rain:
    ...
    menu:
        ...
        "Yes.":
            ...
            call monika_holdme_prep (lullaby=MAS_HOLDME_NO_LULLABY, stop_music=True, disable_music_menu=True) from _call_monika_holdme_prep
...
label monika_holdme_long:
    ...
    menu:
        ...
        "{i}Let her rest on you.{/i}":
            ...
            call monika_holdme_prep (lullaby=MAS_HOLDME_NO_LULLABY) from _call_monika_holdme_prep_5
            if mas_isMoniLove():
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_closeness",category=['romance'],prompt=_("Being close to you"),random=True,aff_range=(mas_aff.AFFECTIONATE, None)))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['advice']
    addEvent(Event(persistent.event_database,eventlabel="monika_confidence",category=category,prompt=_("Faking confidence"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['monika','school']
    addEvent(Event(persistent.event_database,eventlabel="monika_debate",category=category,prompt=_("What was debate club like?"),pool=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['advice']
    addEvent(Event(persistent.event_database,eventlabel="monika_internet",category=category,prompt=_("The internet is for..."),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['acerca de la vida','romance']
    else:
        category = ['life','romance']
    addEvent(Event(persistent.event_database,eventlabel="monika_lazy",category=category,prompt=_("Laziness"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['psichology']
    addEvent(Event(persistent.event_database,eventlabel="monika_mentalillness",category=category,prompt=_("Mental sickness"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['avisos','literatura']
    else:
        category = ['advice','literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_read",category=category,prompt=_("Becoming a reader"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['ddlc','el Club de Literatura']
    else:
        category = ['ddlc','literature club']
    addEvent(Event(persistent.event_database,eventlabel="monika_festival",category=category,prompt=_("Missing the festival"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['multimedia','miembros del club']
    else:
        category = ['media','club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_tsundere",category=category,prompt=_("What is a tsundere?"),pool=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_introduce",category=['monika'],prompt=_("Introducing to friends"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_cold",category=['monika'],prompt=_("Cuddling in the cold"),random=True))
...
init python:
    addEvent(
        Event(
            ...
            category=['monika','romance'],
            prompt=_("Would you ever want to be a housewife?"),
            pool=True
        )
    )
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_route",category=['ddlc'],prompt=_("Monika's route"),random=True))
...
label monika_oneesan:
    ...
    call updateconsole (_("sendmail sister@gmail.com < ./email.txt"), _("Sending mail...")) from _call_updateconsole_17
    pause(1.0)
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_family",category=['monika'],prompt=_("Do you miss your family?"),random=False,pool=True))
...
init python:
    addEvent(
        Event(
            ...
            prompt=_("Have you heard of Libitina?"),
            category=['ddlc'],
            pool=True,
        )
    )
...
init python:
    addEvent(
        Event(
            ...
            prompt=_("Isn't this game metafictional?"),
            category=['ddlc'],
            pool=True,
            unlocked=True
        )
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['games']
    addEvent(Event(persistent.event_database,eventlabel="monika_vn",category=category,prompt=_("Visual novels"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['games']
    addEvent(Event(persistent.event_database,eventlabel="monika_difficulty",category=category,prompt=_("Wasn't DDLC too easy?"),pool=True,unlocked=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_poetry",category=category,prompt=_("Poetry"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_ddlc",category=['ddlc'],prompt=_("What did you think of DDLC?"),pool=True,unlocked=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_dan",category=['ddlc'],prompt=_("Do you like Dan Salvato?"),pool=True))
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo']
    else:
        category = ['misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_4chan",category=category,prompt=_("Have you ever been to 4chan?"),pool=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['games']
    addEvent(Event(persistent.event_database,eventlabel="monika_vidya",category=category,prompt=_("Do you like video games?"),pool=True))
...
init python:
    if persistent.language == "spanish":
        category = ['literatura','el Club de Literatura']
    else:
        category = ['literature','literature club']
    addEvent(Event(persistent.event_database,eventlabel="monika_books",category=category,prompt=_("Books"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['literatura','monika']
    else:
        category = ['literature','monika']
    addEvent(Event(persistent.event_database,eventlabel="monika_favpoem",category=category,prompt=_("What's your favorite poem?"),pool=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature','monika']
    addEvent(Event(persistent.event_database,eventlabel="monika_favbook",category=category,prompt=_("What's your favorite book?"),pool=True))
...
label monika_love:
    if mas_isMoniBroken():
        ...
        python:
            love_quips_dis = [
                _("I...I really wish I could believe that, [player]."),
                _("You have no idea how much I wished that were true, [player]..."),
                _("...It's been a long time since I last believed that, [player]."),
                _("If only I believed you actually meant that, [player]."),
                _("I can't believe there was a time when I actually believed that, [player]."),
                _("...If only that were true, [player]."),
                _("...If only you meant that, [player]."),
                _("How long are you going to keep pretending, [player]?"),
                _("You don't mean that anymore... {w=1}Did you ever?"),
                _("I can't remember the last time I felt like you meant that.")
            ]
        ...
        python:
            love_quips_upset_cynical = [
                _("Please don't say that unless you actually mean it, [player]."),
                _("Sometimes I'm not sure how much you actually mean that, [player]."),
                _("Do you really even mean that, [player]?"),
                _("It's starting to feel like those are just words instead of feelings, [player]..."),
                _("I really want to believe that, but sometimes I'm not so sure..."),
                _("I'm not sure how much I believe that."),
                _("Words only mean so much, [player]."),
                _("You say that, but when will you start to show it?"),
                _("You can say it all you want...{w=0.5}I need you to start showing it."),
                _("It doesn't always feel like it..."),
                _("I'm not so sure anymore...")
            ]

            love_quips_upset_hope = [
                _("That means a lot right now."),
                _("That's really nice to hear."),
                _("I'm so relieved to hear you say that."),
                _("You have no idea how much that means right now."),
                _("I'm glad you still feel that way."),
                _("I'm happy to hear that."),
                _("That means a lot."),
                _("You have no idea how much that means to me.")
            ]
...
label monika_ilym_fight_start:
    ...
    python:
        ...
        ilym_quip = renpy.substitute(_("I love you more, [player]!"))



        ilym_no_quips = [
            _("No, "),
            _("Not a chance, [mas_get_player_nickname()]. "),
            _("Nope, "),
            _("No,{w=0.1} no,{w=0.1} no,{w=0.1} "),
            _("No way, [mas_get_player_nickname()]. "),
            _("That's impossible...{w=0.3}")
        ]
        ...
        ilym_quips = [
            _("I love you waaaaaaaaay more!"),
            _("I definitely love you more!"),
            _("I love you more!"),
            _("I love you way more!")
        ]
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['philosophy','psichology']
    addEvent(Event(persistent.event_database,eventlabel="monika_hedgehog",category=category,prompt=_("Hedgehog dilemma"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_freewill",category=category,prompt=_("Determinism"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_functionalism",category=category,prompt=_("Human functionalism"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['ddlc','un poco de todo']
    else:
        category = ['ddlc','misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_technique",category=category,prompt=_("Changing the code"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_contribute",category=['mod'],prompt=_("Contributions"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['media']
    addEvent(Event(persistent.event_database,eventlabel="monika_drawing",category=category,prompt=_("Can you draw?"),pool=True))
...
init python:
    if persistent.language == "spanish":
        category = ['romance','ddlc','miembros del club']
    else:
        category = ['romance','ddlc','club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_mc",category=category,prompt=_("The MC"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo','avisos']
    else:
        category = ['misc','advices']
    addEvent(Event(persistent.event_database,eventlabel="monika_heroism",category=category,prompt=_("Heroism"),random=True))
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=['philosophy'],
            prompt=_("How would you answer the trolley problem?"),
            pool=True,
            sensitive=True
        )
    )
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_girlfriend",category=['romance'],prompt=_("Do you want to meet my girlfriend?"),pool=True,unlocked=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['media']
    addEvent(Event(persistent.event_database,eventlabel="monika_waifus",category=category,prompt=_("Waifus"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['filosofía','multimedia']
    else:
        category = ['philosophy','media']
    addEvent(Event(persistent.event_database,eventlabel="monika_images",category=category,prompt=_("Fanart"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_herself",category=['monika','ddlc'],prompt=_("Tell me about yourself"),pool=True,unlocked=True))
...
init python:
    if persistent.language == "spanish":
        category = ['juegos','multimedia','literatura']
    else:
        category = ['games','media','literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_vnanalysis",category=category,prompt=_("Appreciating visual novels"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_torment",category=category,prompt=_("Nature of man"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_birthday",category=['monika'],prompt=_("When is your birthday?"),pool=True,unlocked=True))
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo','trivia']
    else:
        category = ['misc','trivia']
    addEvent(Event(persistent.event_database,eventlabel="monika_eyecontact",category=category,prompt=_("Eye contact"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo','mod','monika']
    else:
...
init python:
    if persistent.language == "spanish":
        category = ['literatura','yo']
    else:
        category = ['literature','you']
    addEvent(Event(persistent.event_database,eventlabel="monika_playerswriting",category=category,prompt=_("[player]'s writings"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['filosofía','monika','miembros del club']
    else:
        category = ['philosophy','monika','club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_ghost",category=category,prompt=_("Supernatural"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_ribbon",category=['monika'],prompt=_("Ribbons"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_algernon",category=category,prompt=_("Flowers for Algernon"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['you']
    addEvent(Event(persistent.event_database,eventlabel="monika_playersface",category=category,prompt=_("[player]'s face"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['miembros del club','un poco de todo']
    else:
        category = ['club members','misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_spiders",category=category,prompt=_("Spiders"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo','monika']
    else:
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Can you do any impressions?"),
            pool=True,
            sensitive=True
        )
    )
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_weary",category=['romance'],prompt=_("Will you ever get tired of me?"),pool=True,aff_range=(mas_aff.NORMAL, None)))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_real",category=['romance'],prompt=_("Our reality"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_mythology",category=category,prompt=_("Ancient mythology"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_fanfiction",category=category,prompt=_("Fanfiction"),random=True))
    ...
    if mas_isMoniAff(higher=True):
        ...
        menu:
            ...
            "{i}Hug Monika.{/i}":
                ...
                call monika_holdme_prep (lullaby=MAS_HOLDME_NO_LULLABY, stop_music=True, disable_music_menu=True) from _call_monika_holdme_prep_7
                call monika_holdme_start from _call_monika_holdme_start_7
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=['philosophy','monika'],
            prompt=_("What was it like to realize the truth?"),
            pool=True
        )
    )
...
init python:
    if persistent.language == "spanish":
        category = ['miembros del club','monika']
    else:
        category = ['club members','monika']
    addEvent(Event(persistent.event_database,eventlabel="monika_name",category=category,prompt=_("Our names"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['society']
    addEvent(Event(persistent.event_database,eventlabel="monika_cities",category=category,prompt=_("Living in the city"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['literatura','miembros del club','monika','psicología']
    else:
        category = ['literature','club members','monika','psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_metaparents",category=category,prompt=_("Parents"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['trivia','sociedad','psicología']
    else:
        category = ['trivia','society','psycology']
    addEvent(Event(persistent.event_database,eventlabel="monika_hygiene",category=category,prompt=_("Personal hygiene"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['sociedad','filosofía']
    else:
        category = ['society','philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_resource",category=category,prompt=_("Valuable resources"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_lottery",category=category,prompt=_("Lottery winnings"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['tecnología','psicología','multimedia']
    else:
        category = ['technology','psychology','media']
    addEvent(Event(persistent.event_database,eventlabel="monika_innovation",category=category,prompt=_("Innovation"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['ddlc','filosofía']
    else:
        category = ['ddlc','philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_regrets",category=category,prompt=_("Do you have any regrets?"),pool=True))
...
init python:
    if persistent.language == "spanish":
        category = ['trivia','psicología']
    else:
        category = ['trivia','psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_hypnosis",category=category,prompt=_("Being hypnotized"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['psicología','avisos','acerca de la vida']
    else:
        category = ['psychology','advice','life']
    addEvent(Event(persistent.event_database,eventlabel="monika_motivation",category=category,prompt=_("Lack of motivation"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['multimedia','un poco de todo']
    else:
        category = ['media','misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_harem",category=category,prompt=_("Harem fantasies"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_hack",category=['ddlc','mod'],prompt=_("Why did you hack my computer?"),pool=True))
label monika_hack:
...
init python:
    if persistent.language == "spanish":
        category = ['miembros del club','trivia']
    else:
        category = ['club members','trivia']
    addEvent(Event(persistent.event_database,eventlabel="monika_cupcake",category=category,prompt=_("Baking cupcakes"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['avisos','miembros del club','yo']
    else:
...
init python:
    if persistent.language == "spanish":
        category = ['monika','un poco de todo']
    else:
...
init python:
    if persistent.language == "spanish":
        category = ['multimedia','tecnología','música']
    else:
...
label monika_vocaloid:
    ...
    if (
        ...
        m 3eua "All you have to do is follow these steps..."
        call monika_add_custom_music_instruct from _call_monika_add_custom_music_instruct_1
    return "derandom"
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Good [mas_globals.time_of_day_3state]"),
            unlocked=True,
            pool=True
        ),
        markSeen=True
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo','yo']
    else:
        category = ['misc','you']
    addEvent(Event(persistent.event_database,eventlabel="monika_japanese",category=category,prompt=_("Speaking Japanese"),random=True))
    ...
    if not persistent._mas_penname:
        ...
        menu:
            ...
            "Yes.":
                ...
                call penname_loop (new_name_question=_("Can you tell me what it is?")) from _call_penname_loop
            "No.":
        ...
        python:
            ...
            if lowerpen == player.lower():
                same_name_question = renpy.substitute(_("Is your pen name still [penname]?"))

            else:
                same_name_question = renpy.substitute(_("Are you still going by '[penname],' [player]?"))
        ...
        menu:
            ...
            "No, I'm using a new one.":
                ...
                m 1hua "I see!"
                show monika 3eua
                call penname_loop (new_name_question="Do you want to tell me your new pen name?") from _call_penname_loop_1
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['society','philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_nuclear_war",category=category,prompt=_("Nuclear warfare"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['literatura','sociedad']
    else:
        category = ['literature','society']
    addEvent(Event(persistent.event_database,eventlabel="monika_pluralistic_ignorance",category=category,prompt=_("Trying to fit in"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['technology']
    addEvent(Event(persistent.event_database,eventlabel="monika_science",category=category,prompt=_("Science advancements"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_surprise",category=['romance'],prompt=_("Surprises"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['games']
    addEvent(Event(persistent.event_database,eventlabel="monika_completionist",category=category,prompt=_("Completionism"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['you']
    addEvent(Event(persistent.event_database,eventlabel="monika_icecream",category=category,prompt=_("Favorite ice cream"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_sayhappybirthday",category=category,prompt=_("Can you tell someone Happy Birthday for me?"),pool=True,unlocked=True))
...
label monika_sayhappybirthday:
    ...
    python:
        ...
        take_threshold = 5 
        max_age = 121 
        age_prompt = _("What is their age?" )
    ...
    while not done:
        ...
        $ bday_name = renpy.input(_("What's their name?"),allow=letters_only,length=40).strip()
...
init python:
    if persistent.language == "spanish":
        category = ['romance','monika','acerca de la vida']
    else:
        category = ['romance','monika','life']
    addEvent(Event(persistent.event_database,eventlabel="monika_home_memories",category=category,prompt=_("Making memories"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['juegos','romance']
    else:
        category = ['games','romance']
    addEvent(Event(persistent.event_database,eventlabel="monika_adventure",category=category,prompt=_("Adventuring"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_fahrenheit451",category=category,prompt=_("Book recommendations"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_piggybank",category=category,prompt=_("Saving money"),random=True))
...
label monika_daydream:
    ...
    python:
        ...
        daydream_quips_upset = [
            _("what it was like when we first met..."),
            _("how I felt when I first met you..."),
            _("the good times we used to have..."),
            _("the hope I used to have for our future...")
        ]


        daydream_quips_normplus = [
            _("the two of us reading a book together on a cold winter day, snuggled up under a warm blanket..."),
            _("us having a duet together, with you singing my song while I play the piano..."),
            _("us having a romantic dinner together, just you and me~"),
            _("us having a late night on the couch together..."),
            _("you holding my hand while we take a stroll outside on a sunny day..."),
        ]


        daydream_quips_happyplus = list(daydream_quips_normplus)
        daydream_quips_happyplus.extend([
            _("us cuddling while we're watching a show..."),
        ])
        ...
        daydream_quips_enamplus.extend([
            _("waking up next to you in the morning, watching you sleep beside me..."),
        ])


        if renpy.seen_label("mas_monika_cherry_blossom_tree"):
            daydream_quips_enamplus.append(_("the two of us resting our heads under the cherry blossom tree..."))


        if persistent._mas_pm_hair_length is not None and persistent._mas_pm_hair_length != "bald":
            daydream_quips_enamplus.append(_("me gently playing with your hair while your head rests in my lap..."))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_pets",category=['monika'],prompt=_("Owning pets"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo','miembros del club']
    else:
        category = ['misc','club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_dogs",category=category,prompt=_("Man's best friend"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_cats",category=category,prompt=_("Feline companions"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['monika','trivia']
    else:
        category = ['monika','trivia']
    addEvent(Event(persistent.event_database,eventlabel="monika_fruits",category=category,prompt=_("Eating fruits"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['multimedia','literatura','música']
    else:
    ...
    menu:
        ...
        "Yes.":
            ...
            if (
                ...
                m 3eua "All you have to do is follow these steps..."
                call monika_add_custom_music_instruct from _call_monika_add_custom_music_instruct_2
        "No.":
...
init python:
    if persistent.language == "spanish":
        category = ['literatura','multimedia']
    else:
        category = ['literature','media']
    addEvent(Event(persistent.event_database,eventlabel="monika_standup",category=category,prompt=_("Stand-up comedy"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['acerca de la vida','un poco de todo']
    else:
        category = ['life','misc']
    addEvent(
        Event(
...
init python:
    if persistent.language == "spanish":
        category = ['monika','mod','filosofía']
    else:
        category = ['monika','mod','philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_clones",category=category,prompt=_("Being cloned"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['monika','filosofía']
    else:
        category = ['monika','philosophy']
    addEvent(Event(persistent.event_database,eventlabel="monika_immortal",category=category,prompt=_("Age gap"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['monika','psicología']
    else:
        category = ['monika','psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_meditation",category=category,prompt=_("Meditating"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['multimedia','sociedad','yo']
    else:
        category = ['media','society','you']
    addEvent(Event(persistent.event_database,eventlabel="monika_otaku",category=category,prompt=_("Being an otaku"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_selfharm",category=category,prompt=_("Self-harm"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_urgent",category=['romance'],prompt=_("Urgent message"),random=True,aff_range=(mas_aff.NORMAL, None)))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['club members']
    addEvent(Event(persistent.event_database,eventlabel="monika_other_girls",category=category,prompt=_("Do you ever think of the other girls?"),pool=True))
...
init python:
    if persistent.language == "spanish":
        category = ['acerca de la vida','psicología']
    else:
        category = ['life','psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_happiness",category=category,prompt=_("Happiness"),random=True))
...
init python:
    ...
    addEvent(Event(persistent.event_database,eventlabel="monika_how_soon",category=category,prompt=_("Waiting to be together"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_coffee",category=category,prompt=_("Coffee intake"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_1984",category=category,prompt=_("Nineteen Eighty-Four"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc','trivia']
    addEvent(Event(persistent.event_database,eventlabel="monika_wolf",category=category,prompt=_("From wolves to dogs"),random=True))
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("I'm breaking up with you"),
            unlocked=True,
            pool=True,
            rules={"no_unlock": None}
        )
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['literature']
    addEvent(Event(persistent.event_database,eventlabel="monika_hamlet",category=category,prompt=_("Hamlet"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_omamori",category=category,prompt=_("Omamori"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['you']
    addEvent(Event(persistent.event_database,eventlabel="monika_smoking",category=category,prompt=_("Smoking"),random=True))
    ...
    menu:
        ...
        "Yes, I do.":
            ...
            if persistent._mas_pm_do_smoke_quit:
                ...
                call monika_smoking_just_started from _call_monika_smoking_just_started
            else:
        ...
        "No, I don't.":
            ...
            if persistent._mas_pm_do_smoke:
                call monika_smoking_quit from _call_monika_smoking_quit
            else:
        ...
        "I'm trying to quit.":
            ...
            if persistent._mas_pm_do_smoke is False and not persistent._mas_pm_do_smoke_quit_succeeded_before:
                call monika_smoking_just_started (trying_quit=True) from _call_monika_smoking_just_started_1
            else:
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_cartravel",category=['romance'],prompt=_("Road trip"),random=True))
...
init python:
    addEvent(Event(persistent.event_database,eventlabel="monika_100k",category=['mod'],prompt=_("100k Downloads"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['you']
    addEvent(Event(persistent.event_database,eventlabel="monika_asks_family",category=category,prompt=_("[player]'s family"),random=False))
...
init python:
    if persistent.language == "spanish":
        category = ['monika','romance','un poco de todo']
    else:
        category = ['monika','romance','misc']
    addEvent(
        Event(
            persistent.event_database,
            eventlabel="monika_explain",
            category=category,
            prompt=_("Can you explain our relationship to someone?"),
            pool=True
        )
    )
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['media','misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_timetravel",category=category,prompt=_("Time travel"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['school']
    addEvent(Event(persistent.event_database,eventlabel="monika_prom",category=category,prompt=_("Prom"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['yo','acerca de la vida']
    else:
        category = ['you','life']
    addEvent(Event(persistent.event_database,eventlabel="monika_hydration",prompt=_("Hydration"),category=category,random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc']
    addEvent(Event(persistent.event_database,eventlabel="monika_amusementpark",category=category,prompt=_("Amusement parks"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo','psicología']
    else:
        category = ['misc','psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_challenge",category=category,prompt=_("Challenges"),random=True))
...
init python:
    if persistent.language == "spanish":
        category = ['acerca de la vida','monika']
    else:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Do you like fast food?"),
            pool=True
        )
    )
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['misc','psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_dreaming",category=category,prompt=_("Dreaming"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['advice']
    addEvent(Event(persistent.event_database,eventlabel="monika_procrastination",category=category,prompt=_("Procrastination"),random=True))
...
label monika_players_friends:
    ...
    menu:
        ...
        "Yes.":
            ...
            call monika_players_friends_feels_lonely_ask (question=_("Do you ever feel lonely?")) from _call_monika_players_friends_feels_lonely_ask
        "Only a few.":
            ...
            call monika_players_friends_feels_lonely_ask (question=renpy.substitute(_("Do you ever feel lonely, [player]?")), exp="monika 1euc") from _call_monika_players_friends_feels_lonely_ask_1
        "No, actually...":
            ...
            call monika_players_friends_feels_lonely_ask (question=renpy.substitute(_("Do you ever feel lonely, [player]?"))) from _call_monika_players_friends_feels_lonely_ask_2
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Can I hear your graduation speech now?"),
            pool=True,
            unlocked=False,
            rules={"no_unlock": None}
        )
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['life']
    addEvent(Event(persistent.event_database,eventlabel="monika_savingwater",category=category,prompt=_("Water conservation"),random=True))
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Pygmalion and the Statue"),
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("What if I came to your world?"),
            pool=True,
        )
    )
...
init python:
    addEvent(
        Event(
            ...
            category=['monika'],
            prompt=_("What's your favorite car?"),
            unlocked=False,
            pool=True,
            rules={"no_unlock": None}
        )
    ...
    if persistent._mas_pm_driving_can_drive:
        ...
        menu:
            ...
            "Yes.":
                ...
                python:
                    option_list = [
                        (_("An SUV."), "monika_vehicle_suv",False,False),
                        (_("A pickup truck."),"monika_vehicle_pickup",False,False), 
                        (_("A sports car."),"monika_vehicle_sportscar",False,False),
                        (_("A sedan."),"monika_vehicle_sedan",False,False),
                        (_("A hatchback."),"monika_vehicle_hatchback",False,False),
                        (_("A motorcycle."),"monika_vehicle_motorcycle",False,False),
                        (_("Another vehicle."),"monika_vehicle_other",False,False)
                    ]

                    renpy.say(m, _("Is it any of the vehicles I mentioned, or is it something else?"), interact=False)
...
label monika_player_appearance:
    ...
    menu:
        ...
        "Yes.":
            ...
            call expression "monika_player_appearance_eye_color_{0}".format(eye_color) from _call_expression_4
...
label monika_player_appearance_eye_color_heterochromia:
    ...
    call monika_player_appearance_eye_color_ask from _call_monika_player_appearance_eye_color_ask
    $ eyes_colors.append(_return)
    call monika_player_appearance_eye_color_ask ("right", eye_color) from _call_monika_player_appearance_eye_color_ask_1
    $ eyes_colors.append(_return)
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['nature']
    addEvent(Event(persistent.event_database,eventlabel="monika_backpacking",category=category,prompt=_("Backpacking"),random=not mas_isWinter()))
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("When did we start dating?"),
            pool=True,
            unlocked=False,
...
label monika_whydoyouloveme:
    if mas_isMoniBroken():
        ...
        if not renpy.seen_label('monika_whydoyouloveme_tease') and renpy.random.randint(1, 4) == 1:
            call monika_whydoyouloveme_tease from _call_monika_whydoyouloveme_tease
...
init python:
    if persistent.language == "spanish":
        category = ['mod','multimedia','música']
    else:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("How do I add my own music?"),
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Can you check for new music?"),
            conditional="persistent._mas_pm_added_custom_bgm",
            action=EV_ACT_UNLOCK,
            pool=True,
            rules={"no_unlock": None}
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("[player]'s second choice"),
            random=True
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Have you ever had a snowball fight?"),
            pool=True,
...
init python:
    if persistent.language == "spanish":
        category = ['invierno','romance']
    else:
        category = ['winter','romance']
    addEvent(
        Event(
            persistent.event_database,
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Comfortable in a relationship"),
            random=True,
            aff_range=(mas_aff.AFFECTIONATE,None)
        )
    )
...
init python:
    if persistent.language == "spanish":
        category = ['avisos','acerca de la vida']
    else:
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['spring']
    addEvent(Event(persistent.event_database,eventlabel="monika_enjoyingspring",category=category,prompt=_("Enjoying spring"),random=mas_isSpring()))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['advice','life']
    addEvent(Event(persistent.event_database,eventlabel="monika_life_skills",category=category,prompt=_("Life skills"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['psychology']
    addEvent(Event(persistent.event_database,eventlabel="monika_unknown",category=category,prompt=_("Fear of the unknown"),random=True))
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['nature']
    addEvent(Event(persistent.event_database,eventlabel="monika_auroras",category=category,prompt=_("Auroras"),random=False,unlocked=False))
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("The history of board games"),
            random=False 
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Changing social norms"),
            random=True
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Multi-perspective approach"),
            random=False
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("The Allegory of the Cave"),
            random=True
        )
    )
...
init python:
    if persistent.language == "spanish":
        category = ['multimedia','literatura']
    else:
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("The Boy in the Striped Pajamas"),
            random=False
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("There Will Come Soft Rains"),
            random=True,
            aff_range=(mas_aff.AFFECTIONATE, None),
            rules={
                "derandom_override_label": "mas_bad_derand_topic",
...
init python:
    addEvent(
        Event(
            ...
            category=["monika"],
            prompt=_("What do you do when I'm away?"),
            pool=True,
            aff_range=(mas_aff.NORMAL, None)
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Using computers healthily"),
            random=True,
            aff_range=(mas_aff.NORMAL, None)
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            prompt=_("Why do we always meet in a classroom?"),
            category=category,
            pool=True,
            unlocked=False,
            rules={"no_unlock":None},
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['life']
    addEvent(Event(persistent.event_database,eventlabel="monika_naps",category=category,prompt=_("Naps"),random=True))
...
init python:
    addEvent(
        Event(
            ...
            prompt=_("Are you still mad at me for deleting you?"),
            category=["ddlc", "monika"],
            pool=True,
            unlocked=False,
            rules={"no_unlock": None},
...
init python:
    addEvent(
        Event(
            ...
            category=['monika'],
            prompt=_("How much of your past do you remember?"),
            pool=True,
            unlocked=False,
            rules={"no_unlock": None}
        )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("How did you get into reading?"),
            pool=True
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Would you ever eat meat?"),
            pool=True,
            unlocked=False,
            rules={"no_unlock": None}
        )
...
init python:
    ...
    addEvent(
        Event(
            ...
            prompt=_("Introverts and extroverts"),
            category=category,
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("The value of literature"),
            random=True
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Would you give me piano lessons?"),
            pool=True,
            unlocked=False,
            rules={"no_unlock":None}
        )
...
init python:
    if persistent.language == "spanish":
        ...
        category = ['nature']
    addEvent(Event(persistent.event_database,eventlabel="monika_stargazing",category=category,prompt=_("Stargazing"),random=True))
...
init python:
    addEvent(
        Event(
            ...
            category=['ddlc'],
            prompt=_("Sayori mentioned a boyfriend once..."),
            pool=True
        )
    )
...
init python:
    if persistent.language == "spanish":
        category = ['un poco de todo','sociedad']
    else:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Do you believe in aliens?"),
            pool=True
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("What happened to the main character?"),
            pool=True,
            rules={"no_unlock":None},
            conditional=(
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("How do you know it's always me talking to you?"),
            pool=True
        )
    )
...
init python:
    addEvent(
        Event(
            ...
            category=['monika'],
            prompt=_("What's your favorite kind of chocolate?"),
            pool=True
        )
    )
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Do you mind when we spend time together quietly?"),
            pool=True,
            unlocked=False,
            rules={"no_unlock":None},
...
init python:
    ...
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("Do you like to cosplay?"),
            pool=True,
        )
    )
...
label monika_utterson:
    if persistent._mas_pm_read_jekyll_hyde:
        call monika_jekyll_hyde from _call_monika_jekyll_hyde
    else:
        ...
        menu:
            ...
            "Yes.":
                ...
                call monika_jekyll_hyde from _call_monika_jekyll_hyde_1
            "No.":
...
init python:
    addEvent(
        Event(
            ...
            category=["monika"],
            prompt=_("What's your favorite cupcake flavor?"),
            pool=True,
            unlocked=False,
            rules={"no_unlock":None},
...
init python:
    if persistent.language == "spanish":
        category = ['multimedia','acerca de la vida']
    else:
        category = ['media','life']
    addEvent(
        Event(
            ...
            category=category,
            prompt=_("What do you think of esports?"),
            pool=True,
        )
    )
