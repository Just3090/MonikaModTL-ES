...
init python:
    addReaction("mas_reaction_gift_coffee", _("coffee"), is_good=True, exclude_on=["d25g"])
    ...
    if mas_consumable_coffee.isMaxedStock():
        ...
        if mas_consumable_coffee.enabled() and mas_consumable_coffee.hasServing():
            ...
            if (
                ...
                call mas_transition_from_emptydesk () from _call_mas_transition_from_emptydesk_31
...
init python:
    addReaction("mas_reaction_hotchocolate", _("hotchocolate"), is_good=True, exclude_on=["d25g"])
    ...
    if mas_consumable_hotchocolate.isMaxedStock():
        ...
        if mas_consumable_hotchocolate.enabled() and mas_consumable_hotchocolate.hasServing():
            ...
            if (
                ...
                call mas_transition_to_emptydesk from _call_mas_transition_to_emptydesk_12
                pause 5.0
                call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_32
...
init python:
    addReaction("mas_reaction_gift_thermos_mug", _("justmonikathermos"), is_good=True)
...
init python:
    addReaction("mas_reaction_quetzal_plush", _("quetzalplushie"), is_good=True)
...
init python:
    addReaction("mas_reaction_promisering", _("promisering"), is_good=True, exclude_on=["d25g"])
...
label mas_reaction_promisering:
    if not persistent._mas_acs_enable_promisering:
        ...
        if mas_isMoniEnamored(higher=True):
            ...
            m 6dkbltdu "..."
            m 6ekbfa "I...I just...I..."
            call monika_kissing_motion (hide_ui=False) from _call_monika_kissing_motion_11
...
init python:
    addReaction("mas_reaction_cupcake", _("cupcake"), is_good=True, exclude_on=["d25g"])
...
init python:
    ...
    if mas_isO31():
        addReaction("mas_reaction_candy", _("candy"), is_good=True)
...
label mas_reaction_candy:
    ...
    if times_candy_given == 0:
        ...
        call mas_wx_cmd ("import os", local_ctx, w_wait=1.0) from _call_mas_wx_cmd_3
        call mas_wx_cmd ("os.remove(os.path.normcase(basedir+'/characters/candy.gift'))", local_ctx, w_wait=1.0, x_wait=1.0) from _call_mas_wx_cmd_4
...
init python:
    ...
    if mas_isO31():
        addReaction("mas_reaction_candycorn", _("candycorn"), is_good=False)
...
label mas_reaction_candycorn:
    ...
    if times_candy_given == 0:
        ...
        call mas_wx_cmd ("import os", local_ctx, w_wait=1.0) from _call_mas_wx_cmd_5
        call mas_wx_cmd ("os.remove(os.path.normcase(basedir+'/characters/candycorn.gift'))", local_ctx, w_wait=1.0, x_wait=1.0) from _call_mas_wx_cmd_6
        $ store.mas_ptod.ex_cn()
        hide screen mas_py_console_teaching
        show monika at t11
...
init python:
    addReaction("mas_reaction_fudge", _("fudge"), is_good=True, exclude_on=["d25g"])
...
init python:
    if store.mas_isD25Season():
        addReaction("mas_reaction_christmascookies", _("christmascookies"), is_good=True, exclude_on=["d25g"])
    ...
    if mas_consumable_christmascookies.isMaxedStock():
        ...
        if mas_consumable_christmascookies.enabled() and mas_consumable_christmascookies.hasServing():
            ...
            if not is_having_food and monika_chr.is_wearing_acs(mas_acs_center_quetzalplushie):
                ...
                $ monika_chr.remove_acs(mas_acs_center_quetzalplushie)
                pause 3.0
                call mas_transition_from_emptydesk from _call_mas_transition_from_emptydesk_33
...
init python:
    if store.mas_isD25Season():
        addReaction("mas_reaction_candycane", _("candycane"), is_good=True, exclude_on=["d25g"])
    ...
    if mas_consumable_candycane.isMaxedStock():
        ...
        if mas_consumable_candycane.enabled() and mas_consumable_candycane.hasServing():
            ...
            if not is_having_food and monika_chr.is_wearing_acs(mas_acs_center_quetzalplushie):
                ...
                $ monika_chr.remove_acs(mas_acs_center_quetzalplushie)
                pause 3.0
                call mas_transition_from_emptydesk from _call_mas_transition_from_emptydesk_34
...
init python:
    addReaction("mas_reaction_blackribbon", _("blackribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_blueribbon", _("blueribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_darkpurpleribbon", _("darkpurpleribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_emeraldribbon", _("emeraldribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_grayribbon", _("grayribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_greenribbon", _("greenribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_lightpurpleribbon", _("lightpurpleribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_peachribbon", _("peachribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_pinkribbon", _("pinkribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_platinumribbon", _("platinumribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_redribbon", _("redribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_rubyribbon", _("rubyribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_sapphireribbon", _("sapphireribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_silverribbon", _("silverribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_tealribbon", _("tealribbon"), is_good=True)
...
init python:
    addReaction("mas_reaction_yellowribbon", _("yellowribbon"), is_good=True)
...
label mas_reaction_gift_acs_anonymioo_ribbon_transexualpride:
    call mas_reaction_json_ribbon_base ("anonymioo_ribbon_transexualpride", "transgender-pride-themed", "mas_reaction_gift_acs_anonymioo_ribbon_transexualpride") from _call_mas_reaction_json_ribbon_base_21
    return
...
init python:
    addReaction("mas_reaction_gift_roses", _("roses"), is_good=True, exclude_on=["d25g"])
...
label mas_reaction_gift_roses:
    ...
    if not persistent._date_last_given_roses and not renpy.seen_label('monika_valentines_start'):
        ...
        if mas_shouldKiss(chance=2, special_day_bypass=True):
            call monika_kissing_motion_short from _call_monika_kissing_motion_short_5
    else:
        ...
        if mas_pastOneDay(persistent._date_last_given_roses):
            ...
            if mas_shouldKiss(chance=4, special_day_bypass=True):
                call monika_kissing_motion_short from _call_monika_kissing_motion_short_6
        else:
...
init python:
    addReaction("mas_reaction_gift_chocolates", _("chocolates"), is_good=True, exclude_on=["d25g"])
...
label mas_remove_choc:
    ...
    call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_35
...
label mas_reaction_gift_clothes_orcaramelo_bikini_shell:
    ...
    call mas_clothes_change (sprite_object) from _call_mas_clothes_change_10
    ...
    if mas_isWinter() or mas_isMoniNormal(lower=True):
        ...
        call mas_clothes_change (clothes) from _call_mas_clothes_change_11
...
label mas_reaction_gift_clothes_finale_jacket_brown:
    ...
    if mas_isSummer():
        ...
        call mas_clothes_change (sprite_object) from _call_mas_clothes_change_14
...
label mas_reaction_gift_clothes_orcaramelo_sweater_shoulderless:
    ...
    call mas_clothes_change (sprite_object) from _call_mas_clothes_change_15
...
label mas_reaction_gift_clothes_velius94_dress_whitenavyblue:
    ...
    call mas_clothes_change (sprite_object, outfit_mode=True) from _call_mas_clothes_change_16
...
label mas_reaction_gift_clothes_mocca_bun_blackandwhitestripedpullover:
    ...
    call mas_clothes_change (sprite_object) from _call_mas_clothes_change_17
...
init python:
    ...
    if not mas_seenEvent("mas_reaction_gift_noudeck"):
        addReaction("mas_reaction_gift_noudeck", _("noudeck"), is_good=True)
    ...
    if mas_isMoniNormal(higher=True):
        ...
        menu:
            ...
            "Yes.":
                ...
                call mas_reaction_gift_noudeck_have_played from _call_mas_reaction_gift_noudeck_have_played
            "No.":
                ...
                menu:
                    ...
                    "Yes.":
                        ...
                        call mas_reaction_gift_noudeck_have_played from _call_mas_reaction_gift_noudeck_have_played_1
                    "No.":

                        call mas_reaction_gift_noudeck_havent_played from _call_mas_reaction_gift_noudeck_havent_played
