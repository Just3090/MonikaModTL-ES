...
init -10 python in mas_selspr:
    ...
    generic_sel_dlg_quips = [
        _("Good choice, [player]!"),
        _("I was thinking the same thing, [player]!"),
        _("Great choice, [player]!"),
        _("What do you think, [player]?"),
        _("How do I look, [player]?"),
        _("I really like this look, [player]!"),
        _("Just what I was thinking!"),
        _("Just what I had in mind!")
    ]
    ...
    disable_sel_dlg_quips = {
        DISB_NONE: None,
        DISB_HAIR_BC_CLOTH: [
            _("That hairstyle doesn't really work with my clothes."),
            _("I don't think this hairstyle really works with this outfit."),
            _("That hairstyle doesn't really work with this outfit."),
            _("I think this hairstyle works better with a different outfit.")
        ],
        DISB_ACS_BC_HAIR: [
            _("That doesn't really work with my hair."),
            _("I don't think this really works with my hairstyle."),
            _("This might work with a different hairstyle."),
            _("I don't really think this goes with my hair.")
        ],
    }
...
label mas_selector_sidebar_select_acs(items, preview_selections=True, only_unlocked=True, save_on_confirm=True, mailbox=None, select_map={}, add_remover=False, remover_name=None, filter_map=None):
    ...
    call mas_selector_sidebar_select (items, store.mas_selspr.SELECT_ACS, preview_selections, only_unlocked, save_on_confirm, mailbox, select_map, add_remover, remover_name, filter_map) from _call_mas_selector_sidebar_select
...
label monika_clothes_select:
    ...
    python:
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox(
            _("Which clothes would you like me to wear?")
        )
    ...
    if mas_isMoniLove():
        ...
        call mas_selector_sidebar_select_clothes (store.mas_selspr.CLOTH_SEL_SL, mailbox=mailbox, select_map=sel_map) from _call_mas_selector_sidebar_select_clothes
    else:
        ...
        call mas_selector_sidebar_select_clothes (gifted_clothes, mailbox=mailbox, select_map=sel_map) from _call_mas_selector_sidebar_select_clothes_1
...
label monika_event_clothes_select:
    ...
    call mas_selector_sidebar_select_clothes (available_clothes, mailbox=mailbox, select_map=sel_map) from _call_mas_selector_sidebar_select_clothes_2
...
label monika_hair_select:
    ...
    python:
        ...
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox(
            _("Which hairstyle would you like me to wear?")
        )
        sel_map = {}
...
label monika_ribbon_select:
    python:
        ...
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox(
            _("Which hair tie would you like me to use?")
        )
        sel_map = {}
    ...
    call mas_selector_sidebar_select_acs (use_acs, mailbox=mailbox, select_map=sel_map, add_remover=True, filter_map=mapping) from _call_mas_selector_sidebar_select_acs_1
...
label monika_hairclip_select:
    call mas_selector_generic_sidebar_select_acs ("left-hair-clip", idle_dlg=_("Which hairclip would you like me to wear?")) from _call_mas_selector_generic_sidebar_select_acs
    return
...
label monika_hairflower_select:
    python:
        ...
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox(
            _("Which flower would you like me to put in my hair?")
        )
        sel_map = {}
...
label monika_earrings_select:
    call mas_selector_generic_sidebar_select_acs ("earrings") from _call_mas_selector_generic_sidebar_select_acs_3
    return
...
label monika_necklace_select:
    call mas_selector_generic_sidebar_select_acs ("necklace", idle_exp="monika 6eua") from _call_mas_selector_generic_sidebar_select_acs_4
    return
