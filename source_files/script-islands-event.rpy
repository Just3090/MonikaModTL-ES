...
label mas_monika_islands:
    ...
    call mas_islands (force_exp="monika 1eua", scene_change=True) from _call_mas_islands_3
...
label mas_monika_islands_progress:
    ...
    menu:
        ...
        "Sure, [m_name].":
            ...
            call mas_islands (force_exp="monika 1hua") from _call_mas_islands_4
...
label mas_islands(fade_in=True, fade_out=True, raise_shields=True, drop_shields=True, enable_interaction=True, check_progression=False, **spaceroom_kwargs):
    ...
    if enable_interaction:
        ...
        while not is_done:
            ...
            if _return is False:
                ...
                call expression _return from _call_expression_2
    else:
    ...
    if fade_out:
        ...
        call spaceroom (**spaceroom_kwargs) from _call_spaceroom_27
