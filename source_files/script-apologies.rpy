...
label monika_playerapologizes:
    ...
    $ player_apology_reasons = {
        ...
        8: _("not spending time with you on your birthday."),
        9: _("the game crashing."),
        10: _("the game crashing."), 
        11: _("not listening to your speech."),
        12: _("calling you evil."),
    ...
    if len(persistent._mas_apology_time_db) > 0:
        ...
        if mas_apology_reason == 0:
            ...
            $ mas_setEVLPropValues(
                "mas_apology_generic",
                prompt=_("...for {0}").format(player_apology_reasons.get(mas_apology_reason,"something."))
            )
    ...
    call expression apology from _call_expression_9
