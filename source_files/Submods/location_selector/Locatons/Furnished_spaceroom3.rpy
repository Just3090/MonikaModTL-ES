...
init -990 python:
    store.mas_submod_utils.Submod(
        ...
        name=_("Custom Room Furnished Spaceroom V3"),
        description=_("This submod adds a homey take on the Spaceroom for you and Monika."),
        version="1.0.8.3"
    )
...
label Furnished_spaceroom3_switch_dlg:
    python:
        switch_quip = renpy.substitute(renpy.random.choice([
            _("Want to play the piano, [player]?"),
            _("I love the hardwood floors!"),
            _("A big couch is perfect for a nap!"),
        ]))
