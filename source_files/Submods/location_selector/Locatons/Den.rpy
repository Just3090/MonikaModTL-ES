...
init -990 python:
    store.mas_submod_utils.Submod(
        ...
        name=_("Custom Room Den"),
        description=_("This submod adds a cozy green-walled room where you can relax with Monika."),
        version="1.0.8.1"
    )
...
label Den_switch_dlg:
    python:
        switch_quip = renpy.substitute(renpy.random.choice([
            _("I love this paint color!"),
            _("You like my awards, [player]?"),
            _("It matches my eyes~"),
        ]))
