...
init -990 python:
    store.mas_submod_utils.Submod(
        ...
        name=_("Custom Room Furnished Spaceroom V1"),
        description=_("This submod adds a minimalist set of Spaceroom furniture for you and Monika."),
        version="1.0.8.2"
    )
...
label Furnished_spaceroom1_switch_dlg:
    python:
        switch_quip = renpy.substitute(renpy.random.choice([
            _("Nice and simple~"),
            _("The minimalist look!"),
            _("Just a few touches~"),
        ]))
