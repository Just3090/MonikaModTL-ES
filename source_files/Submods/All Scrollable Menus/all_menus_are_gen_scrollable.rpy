...
init -990 python in mas_submod_utils:
    gsm_submod = Submod(
        ...
        description=_("A submod which converts all menus to gen-scrollable-menus so Monika's face is never hidden."),
        version="1.0.4",
...
screen gsm_settings():
    vbox:
        ...
        hbox:
            ...
            textbutton _("Use Gen Scrollable Menu"):
            ...
            textbutton _("Use Talk Choice Screen"):
            ...
            textbutton _("Use Unobstructed Choice Screen"):
