...
label monika_ptod_tip002:
    ...
    call mas_wx_cmd (_("type(-22)"), local_ctx) from _call_mas_wx_cmd_9
    call mas_wx_cmd (_("type(0)"), local_ctx) from _call_mas_wx_cmd_10
    call mas_wx_cmd (_("type(-1234)"), local_ctx) from _call_mas_wx_cmd_11
    call mas_wx_cmd (_("type(42)"), local_ctx) from _call_mas_wx_cmd_12


    m 1eub "Floats are used to represent decimals."
    show monika 1eua

    call mas_wx_cmd (_("type(0.14)"), local_ctx) from _call_mas_wx_cmd_13
    call mas_wx_cmd (_("type(9.3)"), local_ctx) from _call_mas_wx_cmd_14
    call mas_wx_cmd (_("type(-10.2)"), local_ctx) from _call_mas_wx_cmd_15
    ...
    call mas_wx_cmd (_("type('This is a string in single quotes')"), local_ctx) from _call_mas_wx_cmd_16
    call mas_wx_cmd (_('type("And this is a string in double quotes")'), local_ctx) from _call_mas_wx_cmd_17
    ...
    call mas_wx_cmd (_("type(True)"), local_ctx) from _call_mas_wx_cmd_18
    call mas_wx_cmd (_("type(False)"), local_ctx) from _call_mas_wx_cmd_19
    ...
    call mas_wx_cmd (_("type(None)"), local_ctx) from _call_mas_wx_cmd_20
...
label monika_ptod_tip003:
    ...
    call mas_wx_cmd ("12 + 3", local_ctx) from _call_mas_wx_cmd_21
    call mas_wx_cmd ("7 * 6", local_ctx) from _call_mas_wx_cmd_22
    call mas_wx_cmd ("121 / 11", local_ctx) from _call_mas_wx_cmd_23
...
label monika_ptod_tip005:
    ...
    call mas_wx_cmd ("a = 10") from _call_mas_wx_cmd_24
    call mas_wx_cmd ("b = 10") from _call_mas_wx_cmd_25
    call mas_wx_cmd ("c = 3") from _call_mas_wx_cmd_26

    m 3eua "To check if two values are equivalent, use two equal signs (==):"
    call mas_wx_cmd ("a == b") from _call_mas_wx_cmd_27
    call mas_wx_cmd ("a == c") from _call_mas_wx_cmd_28

    m 3eua "To check if two values are not equivalent, use an exclamation mark and an equal sign (!=):"
    call mas_wx_cmd ("a != b") from _call_mas_wx_cmd_29
    call mas_wx_cmd ("a != c") from _call_mas_wx_cmd_30
    ...
    call mas_wx_cmd ("a > c") from _call_mas_wx_cmd_31
    call mas_wx_cmd ("a < c") from _call_mas_wx_cmd_32
    ...
    call mas_wx_cmd ("a >= b") from _call_mas_wx_cmd_33
    ...
    call mas_w_cmd ("a != b and a >= c") from _call_mas_w_cmd_3
    ...
    call mas_wx_cmd ("a != b and a == c") from _call_mas_wx_cmd_37
    ...
    call mas_w_cmd ("a != b or a == c") from _call_mas_w_cmd_7
    ...
    call mas_wx_cmd ("not (a == b and a == c)") from _call_mas_wx_cmd_38
    call mas_wx_cmd ("not (a == b or a == c)") from _call_mas_wx_cmd_39
    ...
    call mas_wx_cmd ("not a == b and a == c") from _call_mas_wx_cmd_40
    ...
    call mas_wx_cmd ("d = a == b and a >= c") from _call_mas_wx_cmd_41
    call mas_wx_cmd ("d") from _call_mas_wx_cmd_42
    call mas_wx_cmd ("e = a == b and a == c") from _call_mas_wx_cmd_43
    call mas_wx_cmd ("e") from _call_mas_wx_cmd_44

    m 3eub "And use those variables in comparisons as well!"
    call mas_wx_cmd ("d and e") from _call_mas_wx_cmd_45
    m "Since 'd' is {b}True{/b} but 'e' is {b}False{/b}, this expression evaluates to {b}False{/b}."

    call mas_wx_cmd ("d or e") from _call_mas_wx_cmd_46
    ...
    call mas_wx_cmd ("not (d or e)") from _call_mas_wx_cmd_47
    ...
    call mas_wx_cmd ("d and not e") from _call_mas_wx_cmd_48
...
label monika_ptod_tip006:
    ...
    call mas_w_cmd ("b_number = a_number  -  " + b_num_store) from _call_mas_w_cmd_9
    ...
    call mas_wx_cmd ("b_number", local_ctx) from _call_mas_wx_cmd_50


    m 3eua "Note that if we enter in a symbol that hasn't been assigned anything, Python will complain."
    call mas_wx_cmd ("c_number", local_ctx) from _call_mas_wx_cmd_51

    m 3eub "But if we assign this symbol a value..."
    show monika 3eua
    call mas_wx_cmd ("c_number = b_number * a_number", local_ctx) from _call_mas_wx_cmd_52
    call mas_wx_cmd ("c_number", local_ctx) from _call_mas_wx_cmd_53
...
label monika_ptod_tip007:
    ...
    call mas_wx_cmd ("import sys", local_ctx) from _call_mas_wx_cmd_54
    call mas_wx_cmd ("sys.getsizeof(a_number)", local_ctx) from _call_mas_wx_cmd_55
...
label monika_ptod_tip008:
    ...
    call mas_wx_cmd ("10") from _call_mas_wx_cmd_58
    ...
    call mas_wx_cmd ("23") from _call_mas_wx_cmd_59
    call mas_wx_cmd ("21.05") from _call_mas_wx_cmd_60
    m 3eua "These are {b}integer{/b} and {b}float{/b} literals."

    call mas_wx_cmd (_('"this is a string"')) from _call_mas_wx_cmd_61
    call mas_wx_cmd (_("'this is another string'")) from _call_mas_wx_cmd_62
    m "These are {b}string{/b} literals."

    call mas_wx_cmd (_("True")) from _call_mas_wx_cmd_63
    call mas_wx_cmd (_("False")) from _call_mas_wx_cmd_64
    m "These are {b}boolean{/b} literals."

    call mas_wx_cmd ("None") from _call_mas_wx_cmd_65
    ...
    call mas_wx_cmd ("10 + 21") from _call_mas_wx_cmd_66
    call mas_wx_cmd ("10 * 5") from _call_mas_wx_cmd_67
    m "We can do math with literals instead of variables."

    call mas_wx_cmd ("a + 21") from _call_mas_wx_cmd_68
    call mas_wx_cmd ("a * 5") from _call_mas_wx_cmd_69
...
label monika_ptod_tip009:
    ...
    call mas_wx_cmd ("bool(10)") from _call_mas_wx_cmd_70
    call mas_wx_cmd ("bool(-1)") from _call_mas_wx_cmd_71
    m 3eua "All non-zero integers have a truth value of {b}True{/b}."
    call mas_wx_cmd ("bool(0)") from _call_mas_wx_cmd_72
    m 3eub "Zero, on the other hand, has a truth value of {b}False{/b}."

    m 1eua "Floats follow the same rules as integers:"
    call mas_wx_cmd ("bool(10.02)") from _call_mas_wx_cmd_73
    call mas_wx_cmd ("bool(0.14)") from _call_mas_wx_cmd_74
    call mas_wx_cmd ("bool(0.0)") from _call_mas_wx_cmd_75

    m 1eua "Now let's look at strings."
    call mas_wx_cmd ('bool("string with text")') from _call_mas_wx_cmd_76
    call mas_wx_cmd ('bool("  ")') from _call_mas_wx_cmd_77
    m 3eub "A string with text, even if the text is only whitespace characters, has a truth value of {b}True{/b}."
    call mas_wx_cmd ('bool("")') from _call_mas_wx_cmd_78
    m "An empty string, or a string with length 0, has a truth value of {b}False{/b}."

    m 1eua "Now let's look at {b}None{/b}."
    call mas_wx_cmd ("bool(None)") from _call_mas_wx_cmd_79
    ...
    call mas_wx_cmd ("num10 = 10") from _call_mas_wx_cmd_80
    call mas_wx_cmd ("num0 = 0") from _call_mas_wx_cmd_81
    call mas_wx_cmd ('text = "text"') from _call_mas_wx_cmd_82
    call mas_wx_cmd ('empty_text = ""') from _call_mas_wx_cmd_83
    call mas_wx_cmd ("none_var = None") from _call_mas_wx_cmd_84

    m 3eub "And then do several comparisons."
    call mas_wx_cmd ("bool(num10 and num0)") from _call_mas_wx_cmd_85
    call mas_wx_cmd ("bool(num10 and text)") from _call_mas_wx_cmd_86
    call mas_wx_cmd ("bool(empty_text or num0)") from _call_mas_wx_cmd_87
    call mas_wx_cmd ("bool(none_var and text)") from _call_mas_wx_cmd_88
    call mas_wx_cmd ("bool(empty_text or none_var)") from _call_mas_wx_cmd_89
...
init -6 python in mas_ptod:
    ...
    VER_TEXT_1 = _("Python {0}")
    VER_TEXT_2 = _("{0} in MAS")
...
label mas_wx_cmd_noxwait(cmd, ctx=None):
    call mas_wx_cmd (cmd, ctx, x_wait=0.0) from _call_mas_wx_cmd_90
    return
