...
label mas_affection_playernickname:
    python:
        ...
        base_nicknames = [
            (_("Darling"), _("darling"), True, True, False),
            (_("Honey"), _("honey"), True, True, False),
            (_("Love"), _("love"), True, True, False),
            (_("My love"), _("my love"), True, True, False),
            (_("Sweetheart"), _("sweetheart"), True, True, False),
            (_("Sweetie"), _("sweetie"), True, True, False),
        ]
...
label monika_change_player_nicknames:
    ...
    python:
        ...
        if not persistent._mas_player_nicknames:
            current_nicknames = [
                (_("Darling"), _("darling"), False, True, False),
                (_("My darling"), _("my darling"), False, True, False),
                (_("Dear"), _("dear"), False, True, False),
                (_("My dear"), _("my dear"), False, True, False),
                (_("Honey"), _("honey"), False, True, False),
                (_("Love"), _("love"), False, True, False),
                (_("My love"), _("my love"), False, True, False),
                (_("Sweetheart"), _("sweetheart"), False, True, False),
                (_("Sweetie"), _("sweetie"), False, True, False),
            ]
