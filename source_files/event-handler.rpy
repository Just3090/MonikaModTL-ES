...
label prompt_menu:
    ...
    if store.mas_globals.in_idle_mode:
        ...
        if cb_label is not None and renpy.has_label(cb_label):
            call expression cb_label from _call_expression_6
        else:
    ...
    python:
        ...
        if renpy.android:
            talk_menu.append((_("Menu Android"), "Android"))
    ...
    if madechoice == "unseen":
        ...
        call mas_farewell_start from _call_mas_farewell_start
    elif madechoice == "Android":
        call android_menu from _call_android_menu
    else:
