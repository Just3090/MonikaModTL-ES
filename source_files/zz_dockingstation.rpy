...
label mas_dockstat_first_time_goers:
    call mas_transition_from_emptydesk ("monika 3eua") from _call_mas_transition_from_emptydesk_20
...
label mas_dockstat_empty_desk:
    ...
    call spaceroom (hide_monika=True, scene_change=True) from _call_spaceroom_32
...
label mas_dockstat_different_monika:
    ...
    call mas_transition_from_emptydesk ("monika 1ekd") from _call_mas_transition_from_emptydesk_21
...
label mas_dockstat_generic_iowait:
    ...
    if renpy.has_label(mas_farewells.dockstat_wait_menu_label):
        call expression mas_farewells.dockstat_wait_menu_label from _call_expression_3
    else:

        call mas_dockstat_generic_wait_label from _call_mas_dockstat_generic_wait_label
...
label mas_dockstat_generic_wait_label:
    menu:
        ...
        "Actually, I can't take you right now.":
            ...
            call mas_transition_from_emptydesk ("monika 1ekc") from _call_mas_transition_from_emptydesk_22
...
label mas_dockstat_generic_rtg:
    ...
    if _return:
        ...
        call mas_transition_from_emptydesk ("monika 1eua") from _call_mas_transition_from_emptydesk_23


        m 1eua "I'm ready to go."
        return "quit"
    call mas_transition_from_emptydesk ("monika 1ekc") from _call_mas_transition_from_emptydesk_24
